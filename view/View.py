...
class View(tk.Tk):
    ...
    def refresh_table(self):
        ...
        customers = self.controller.getAllCustomers()
        if customers:
    ...
    def add_customer(self):
        ...
        def save_customer():
            ...
            self.controller.createCustomer(name,surname,address)
            add_window.destroy()
            self.refresh_table()
    ...
    def delete_customer(self):
        ...
        def delete():
            id = int(id_entry.get())
            self.controller.deleteCustomer(id)
    ...
    def update_customer(self):
        ...
        def update():
            id = int(id_entry.get())
            customer = self.controller.getCustomer(id)
            name=name_entry.get()
            surname=surname_entry.get()
            address=address_entry.get()
            self.controller.updateCustomer(id,name,surname,address)   
